                ...
                <div class="col-md-12">
                    <?php
                        if(isset($_POST['tambah'])){
                         ...
                         if(!empty($_FILES['images']['tmp_name'])){
                            ...
                            $query = mysqli_query($db, "INSERT INTO hadits(no, title, brief, detail, foto) VALUES ('$no','$title','$brief','$detail','$newfilename')");
                            if (!$query) {
                            ...
                            $query = mysqli_query($db, "INSERT INTO hadits(no, title, brief, detail, foto) VALUES ('$no','$title','$brief','$detail','default.jpg')");
                            if (!$query) {
                                $message = mysqli_error($db);
                                echo "<div class='alert alert-danger' role='alert' id='alert-edit'>" . $message . "</div>";
                            }else{
                    ...
                    <form method="post" action="" enctype="multipart/form-data" >
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="no" name="no" placeholder="" value="">
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group text-center">
                        <input type="submit" class="btn btn-secondary border-radius mt-4 mb-3 mr-2" value="Back" name="back">
                        <input type="submit" class="btn btn-primary border-radius mt-4 mb-3" value="Tambah" name="tambah">
                      </div>
                    </form>
                </div>
            </div>
